...
class Integer(int):
    ...
    def __truediv__(self, o):
        return Integer(old_div(int(self), int(o)))
    def __div__(self, o):
        return Integer(old_div(int(self), int(o)))
    def __mod__(self, o):
        return Integer(int(self) % int(o))
...
class Fact(object):
    ...
    def __init__(self, o):
        ...
        class __fact_Slots(object):
            ...
            @_forces_method(str)
            def has_key(self, k):
                return k in list(map(str, _cl2py(_c.factSlotNames(self.__fact))))
